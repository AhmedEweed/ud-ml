...
for key in data_dict.keys():
    if(data_dict[key]['exercised_stock_options'] != 'NaN'):
        exer_sto_opt.append(data_dict[key]['exercised_stock_options'])
print('Max Stock options: ', max(exer_sto_opt), '\n', 'Min Stock options: ', min(exer_sto_opt), '\n')
...
pred = KMeans(2, random_state = 0).fit_predict(data)
